...
static unsigned long psu_clock_init_data(void)
{
	...
	psu_mask_write(0xFF18030C, 0x00000003U, 0x00000001U);
...
static unsigned long psu_ddr_init_data(void)
{
	...
	psu_mask_write(0xFD070064, 0x0FFF83FFU, 0x0092814AU);
	...
	psu_mask_write(0xFD070120, 0x7F7F7F7FU, 0x05050D0CU);
	psu_mask_write(0xFD070124, 0x40070F3FU, 0x0002040CU);
	psu_mask_write(0xFD07012C, 0x7F1F031FU, 0x1708010EU);
	...
	psu_mask_write(0xFD080120, 0xFFFFFFFFU, 0x02942B08U);
	...
	psu_mask_write(0xFD080414, 0xFFFFFFFFU, 0x12342000U);
...
static unsigned long psu_mio_init_data(void)
{
	...
	psu_mask_write(0xFF180048, 0x000000FEU, 0x00000080U);
	psu_mask_write(0xFF18004C, 0x000000FEU, 0x00000000U);
	psu_mask_write(0xFF180050, 0x000000FEU, 0x00000000U);
	psu_mask_write(0xFF180054, 0x000000FEU, 0x00000080U);
	psu_mask_write(0xFF180058, 0x000000FEU, 0x00000080U);
	psu_mask_write(0xFF18005C, 0x000000FEU, 0x00000080U);
	...
	psu_mask_write(0xFF180098, 0x000000FEU, 0x00000008U);
	psu_mask_write(0xFF18009C, 0x000000FEU, 0x00000008U);
	psu_mask_write(0xFF1800A0, 0x000000FEU, 0x00000008U);
	psu_mask_write(0xFF1800A4, 0x000000FEU, 0x00000008U);
	psu_mask_write(0xFF1800A8, 0x000000FEU, 0x00000008U);
	psu_mask_write(0xFF1800AC, 0x000000FEU, 0x00000008U);
	psu_mask_write(0xFF1800B0, 0x000000FEU, 0x00000008U);
	...
	psu_mask_write(0xFF1800D8, 0x000000FEU, 0x000000C0U);
	psu_mask_write(0xFF1800DC, 0x000000FEU, 0x000000C0U);
	...
	psu_mask_write(0xFF180208, 0xFFFFFFFFU, 0x00400080U);
...
{
	psu_mask_write(0xFD1A0100, 0x000E0044U, 0x00000000U);
	...
	psu_mask_write(0xFF0A0244, 0x03FFFFFFU, 0x00400000U);
	psu_mask_write(0xFF0A0248, 0x03FFFFFFU, 0x00400000U);
	psu_mask_write(0xFF0A000C, 0x03FF03FFU, 0x03BF0040U);
	mask_delay(1);
	psu_mask_write(0xFF0A000C, 0x03FF03FFU, 0x03BF0000U);
	mask_delay(5);
	psu_mask_write(0xFF0A0244, 0x03FFFFFFU, 0x00400000U);
	psu_mask_write(0xFF0A0248, 0x03FFFFFFU, 0x00400000U);
	psu_mask_write(0xFF0A000C, 0x03FF03FFU, 0x03BF0000U);
...
static unsigned long psu_afi_config(void)
{
	...
	psu_mask_write(0xFD380000, 0x00000003U, 0x00000001U);
	psu_mask_write(0xFD380014, 0x00000003U, 0x00000001U);
